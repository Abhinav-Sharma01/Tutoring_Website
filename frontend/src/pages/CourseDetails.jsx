    ...
    <div className="tp-cd tp-grid-bg" style={{ background: bg, minHeight: "100vh", fontFamily: "'Cabinet Grotesk', sans-serif", color: text }}>
      ...
      {showAddLesson && (
        <div style={{ position: "fixed", inset: 0, zIndex: 9999, display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
          ...
          <div style={{ background: "rgba(6,14,24,0.95)", border: "1px solid rgba(0,212,255,0.15)", borderRadius: 24, padding: 32, width: "100%", maxWidth: 500, maxHeight: "90vh", overflowY: "auto", position: "relative", zIndex: 1, boxShadow: "0 24px 80px rgba(0,0,0,0.6), 0 0 40px rgba(0,212,255,0.08)", animation: "tp-fade-up 0.4s ease forwards" }}>
